"""
PlotCode:
    Defines the class to save plot images of the metrics from the trained model
"""
...
class Graph:
    ...
    """
    class to plot and save graph from input metrics
    """
    ...
    def __init__(self, y1, y2, x, param, Set1, Set2, color1, color2):
        ...
        Action:
            Initializes input variables to class
        """
        self.y1 = y1
        self.y2 = y2
        self.x = x
    ...
    def __call__(self):
        """
        Plots the graphs and saves in 'Images/' directory
        """
